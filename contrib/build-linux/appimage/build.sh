...
APPDIR="$BUILDDIR/seedkeeper.AppDir" #APPDIR="$BUILDDIR/electrum.AppDir" #todo
...
cp "$PROJECT_ROOT/seedkeeper.desktop" "$APPDIR/seedkeeper.desktop"
#cp "$PROJECT_ROOT/seedkeeper/gui/icons/satochip.png" "$APPDIR/satochip.png"
